...
async function getApiGithub(){
    try{
        ...
        const dadosPerfil = await fetch(`https://api.github.com/users/junoprice`);
        ...
        let conteudo = `
            ...
            <article id="about_texto">
                <h2>Sobre mim</h2>
                <p>Sou Jonas Gomes, com 10 anos de experiência como professor e biólogo, agora em transição para a tecnologia. Desenvolvi habilidades em comunicação, adaptação e gestão, que me permitem otimizar processos e liderar equipes para soluções inovadoras.</p>
